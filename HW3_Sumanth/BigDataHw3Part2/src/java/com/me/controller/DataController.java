    ...
    protected ModelAndView handleRequestInternal(
        ...
        if (request.getRequestURI().endsWith("search.htm")) {
            ...
            try {
                ...
                db.getCollection("movies").createIndex(Indexes.text("title"));
                db.getCollection("movies").createIndex(Indexes.text("genre"));
                //select collection
            ...
            BasicDBObject query = new BasicDBObject("$text", new BasicDBObject("$search", data));
